    ...
    try {
        ...
        const conteudoUsuario = [{
            ...
            text: JSON.stringify({
                ...
                formatoResposta: {
                    ...
                    confiancaData: 'alta|media|baixa',
        ...
        const payload = {
            ...
            instructions: [
                ...
                'Nunca use a data de emissao, processamento, movimento, competencia, pagamento ou vencimento de outro campo como vencimento.',
                'Para vencimento, procure primeiro o rotulo VENCIMENTO/DATA DE VENCIMENTO/PAGAVEL. Se houver mais de uma data possivel ou o rotulo nao estiver legivel, deixe vencimento vazio, use confiancaData baixa e explique o conflito em observacao.',
                'Nao deduza vencimento somando dias a outra data e nao corrija uma data apenas porque parece antiga ou futura.',
