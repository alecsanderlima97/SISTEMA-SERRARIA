                ...
                <div class="dashboard-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 24px;">
                    ...
                    <div class="glass-panel">
                        ...
                        <div style="display: flex; gap: 12px; flex-direction: column;">
                            <button class="btn-theme" data-theme-option="original" onclick="window.changeTheme('original')" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); background: rgba(255,255,255,0.02); color: #888; cursor: pointer; text-align: left;">
                                <div style="width: 12px; height: 12px; border-radius: 50%; background: #e67e22;"></div>
                                <span>Serraria Original</span>
                            </button>
                            <button class="btn-theme" data-theme-option="premium" onclick="window.changeTheme('premium')" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); background: rgba(255,255,255,0.02); color: #888; cursor: pointer; text-align: left;">
                                <div style="width: 12px; height: 12px; border-radius: 50%; background: #0f8fa6;"></div>
                                <span style="font-weight: bold;">Orquestra Premium</span>
                            </button>
                            <button class="btn-theme" data-theme-option="dark" onclick="window.changeTheme('dark')" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); background: rgba(255,255,255,0.02); color: #888; cursor: pointer; text-align: left;">
                                <div style="width: 12px; height: 12px; border-radius: 50%; background: #0f172a;"></div>
                                <span>Modo Escuro (Moderno)</span>
                            </button>
                            <button class="btn-theme" data-theme-option="light" onclick="window.changeTheme('light')" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); background: rgba(255,255,255,0.02); color: #888; cursor: pointer; text-align: left;">
