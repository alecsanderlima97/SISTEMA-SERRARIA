    ...
    const html = `            <!-- ====== TELA: FINANCEIRO ====== -->
            <section id="view-financeiro" class="view-section" style="display: none;">
                ...
                <div class="dashboard-grid financeiro-kpis hide-on-print" style="margin-bottom: 22px;">
                    ...
                    <div class="kpi-card glass-panel"><div class="kpi-icon" style="background: rgba(16,185,129,0.12); color: #10b981;"><i class="fa-solid fa-circle-check"></i></div><div class="kpi-data"><h3 id="financeiroKpiPagoMes">R$ 0,00</h3><p>Pago no m?s</p></div></div>
                ...
                <div class="tabs-container hide-on-print financeiro-tabs">
                    ...
                    <button type="button" class="btn-tab-financeiro" onclick="window.switchFinanceiroAba('boletos')" data-fin-tab="boletos"><i class="fa-solid fa-barcode"></i> Boletos Aleat?rios</button>
                ...
                <div class="glass-panel financeiro-form-card hide-on-print">
                    <div style="display:flex; justify-content:space-between; gap:12px; align-items:center; flex-wrap:wrap; margin-bottom:16px;">
                        <div><h3 id="financeiroTituloForm" style="margin:0;"><i class="fa-solid fa-plus-circle"></i> Novo lan?amento financeiro</h3><small style="color:var(--text-muted);">Cadastre contas, impostos, boletos e despesas com comprovantes.</small></div>
                    ...
                    <form id="financeiroForm" class="financeiro-form-grid">
                        ...
                        <div class="input-group"><label for="financeiroDescricao">Descri??o</label><input type="text" id="financeiroDescricao" list="financeiroDescricaoList" placeholder="Ex: FGTS, ENERGIA, INTERNET" class="text-uppercase-input"><datalist id="financeiroDescricaoList"></datalist></div>
                        ...
                        <div class="input-group"><label>Status</label><label class="financeiro-status-toggle" for="financeiroPago"><input type="checkbox" id="financeiroPago"><span id="financeiroStatusTexto">N?o pago</span></label></div>
                        <div class="input-group financeiro-obs"><label for="financeiroObservacao">Observa??o</label><textarea id="financeiroObservacao" rows="2" placeholder="Refer?ncia, parcela, fornecedor ou detalhe importante..."></textarea></div>
                        ...
                        <div class="financeiro-form-actions"><button type="submit" class="btn-primary"><i class="fa-solid fa-floppy-disk"></i> Salvar lan?amento</button></div>
                    </form>
                </div>
                ...
                <div class="glass-panel financeiro-list-card">
                    <div class="financeiro-list-header hide-on-print">
                        ...
                        <button type="button" class="btn-primary" onclick="window.abrirRelatorioFinanceiro()"><i class="fa-solid fa-file-lines"></i> Gerar relat?rio</button>
                        <div class="financeiro-filtros"><select id="financeiroFiltroStatus" onchange="window.renderFinanceiro()"><option value="TODOS">Todos</option><option value="ABERTO">N?o pagos</option><option value="PAGO">Pagos</option><option value="VENCIDO">Vencidos</option></select><input type="search" id="financeiroBusca" oninput="window.renderFinanceiro()" placeholder="Buscar lan?amento..."></div>
                    </div>
                    <div class="table-responsive">
                        <table class="financeiro-table">
                            <thead><tr><th>Tipo</th><th>Descri??o</th><th>Vencimento</th><th>Valor</th><th>Status</th><th>Anexos</th><th>A??es</th></tr></thead>
                ...
                <div id="financeiroRelatorioCard" class="glass-panel financeiro-relatorio-card hide-on-print" style="display:none;">
                    <div class="financeiro-list-header">
                        <div><h3 style="margin:0;"><i class="fa-solid fa-file-lines"></i> Relat?rio financeiro</h3><small style="color:var(--text-muted);">Escolha o per?odo e marque os lan?amentos desejados.</small></div>
                    ...
                    <div class="financeiro-relatorio-filtros">
                        <div class="input-group"><label for="financeiroRelatorioInicio">In?cio</label><input type="date" id="financeiroRelatorioInicio"></div>
                        <div class="input-group"><label for="financeiroRelatorioFim">Fim</label><input type="date" id="financeiroRelatorioFim"></div>
                        <div class="input-group"><label for="financeiroRelatorioStatus">Status</label><select id="financeiroRelatorioStatus"><option value="TODOS">Todos</option><option value="ABERTO">N?o pagos</option><option value="PAGO">Pagos</option><option value="VENCIDO">Vencidos</option></select></div>
                    ...
                    <div class="table-responsive">
                        <table class="financeiro-table">
                            <thead><tr><th><input type="checkbox" id="financeiroRelatorioTodos" onchange="window.marcarTodosRelatorioFinanceiro(this.checked)"></th><th>Tipo</th><th>Descri??o</th><th>Vencimento</th><th>Valor</th><th>Status</th></tr></thead>
                            <tbody id="financeiroRelatorioLista"></tbody>
                        </table>
                    </div>
                    <div class="financeiro-form-actions" style="margin-top:14px;"><button type="button" class="btn-primary" onclick="window.imprimirRelatorioFinanceiro()"><i class="fa-solid fa-print"></i> Imprimir relat?rio</button></div>
                </div>
            </section>
