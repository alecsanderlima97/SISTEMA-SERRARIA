            ...
            <section id="view-financeiro" class="view-section" style="display: none;">
                ...
                <div class="glass-panel financeiro-form-card hide-on-print">
                    ...
                    <form id="financeiroForm" class="financeiro-form-grid financeiro-form-clean">
                        ...
                        <div class="input-group fin-situacao"><label for="financeiroSituacaoDocumento">Situação do documento</label><select id="financeiroSituacaoDocumento" onchange="window.atualizarSituacaoFinanceiro?.()"><option value="A_PAGAR">A pagar / boleto</option><option value="PAGO_A_VISTA">Pago à vista</option><option value="AGUARDANDO_BOLETO">Nota fiscal aguardando boleto</option><option value="AGUARDANDO_NOTA">Boleto aguardando nota fiscal</option></select></div>
                        <div class="input-group fin-doc"><label for="financeiroDocumento">Documento</label><div class="financeiro-file-row"><select id="financeiroDocumentoCategoria" title="Tipo do documento"><option value="AUTO">Automático</option><option value="boleto">Boleto</option><option value="nota_fiscal">Nota fiscal</option><option value="xml">XML</option><option value="outro">Outro</option></select><label class="financeiro-file-compact" for="financeiroDocumento"><i class="fa-solid fa-file-arrow-up"></i> Escolher</label><input type="file" id="financeiroDocumento" accept=".pdf,.xml,text/xml,application/xml,image/*"><small id="financeiroDocumentoNome">Nenhum documento anexado</small><button type="button" id="btnLerDocumentoFinanceiro" class="btn-secondary"><i class="fa-solid fa-wand-magic-sparkles"></i></button></div></div>
