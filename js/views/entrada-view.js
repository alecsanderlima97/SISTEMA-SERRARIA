                        ...
                        <div class="glass-panel" id="cardFormEntrada" style="margin-bottom: 0;">
                            ...
                            <form id="formEntrada" class="grid-form">
                                ...
                                <div style="grid-column: 1 / -1; margin-top: 10px;">
                                    <p style="font-size: 0.8rem; color:#aaa; margin-bottom: 5px;">Alturas da carroceria: preencha de 1 a 4 pontos por lado. A média considera somente os pontos informados.</p>
                                </div>

                                <div class="entrada-alturas-grid" style="grid-column: 1 / -1; display:grid; grid-template-columns: repeat(4, minmax(105px, 1fr)); gap:10px;">
                                    ...
                                    <div class="input-group" style="background: rgba(0,0,0,0.2); padding: 8px; border-radius: 8px;">
                                        <label style="color:#2cc990; font-size: 0.75rem;">Lado Esq. 4 (m)</label>
                                        <input type="text" id="entAltEsq4" inputmode="decimal" placeholder="m" style="padding: 8px; font-size: 0.9rem;">
                                    </div>
                                    ...
                                    <div class="input-group" style="background: rgba(0,0,0,0.2); padding: 8px; border-radius: 8px;">
                                        <label style="color:#3498db; font-size: 0.75rem;">Lado Dir. 4 (m)</label>
                                        <input type="text" id="entAltDir4" inputmode="decimal" placeholder="m" style="padding: 8px; font-size: 0.9rem;">
                                    </div>
                                </div>
